...
export default {
  ...
  methods: {
    ...
    async showData(event, obj) {
      const cy = await cyPromise;
      this.$store.dispatch("currentElement", obj);
      ...
      if (obj.constructor.name === "Node") {
        ...
        selectedNodes.outgoers().toggleClass("outgoingNode outgoingEdge", true);
        selectedNodes.incomers().toggleClass("incomingNode incomingEdge", true);
      } else if (obj.constructor.name === "Relationship") {
        selectedEdges.targets().toggleClass("outgoingNode outgoingEdge", true);
        selectedEdges.toggleClass("outgoingNode outgoingEdge", true);
        selectedEdges.sources().toggleClass("incomingNode incomingEdge", true);
